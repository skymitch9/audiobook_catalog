 ...
 *
 * Vendored from catalog-platform (canonical, commit 48f4663 — the site-wide
 * revert) with THREE marked SITE-LOCAL ADDITIONS for the audiobook catalog —
 * preserve them on every re-vendor: (1) ab_theme migrate-once, (2)
 * data-default-mode support (identity: first visit boots dark, as prod always
 * has), (3) theme-color meta sync. This site carries NO #hg-cog markup — the
 * appearance controls live in the account modal (account-modal.js and
 * index.html's inline modal) and drive the window.estateTheme API; the cog
 * wiring below simply no-ops.
 *
